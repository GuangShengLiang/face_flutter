...
class ActivityApprovalTab extends StatefulWidget {
  @override
  _ActivityTabWidgetState createState() => new _ActivityTabWidgetState();
}

class _ActivityTabWidgetState extends State<ActivityApprovalTab> {
  List<Apply> rst;

  @override
  void initState() {
    ActivityClient.applyApprovalList().then((r) {
      setState(() {
        rst = r;
      });
    });
