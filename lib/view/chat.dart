...
import 'package:face_flutter/model/message.dart';
import 'package:face_flutter/view/const.dart';
...
//                )
            ...
            isLastMessageLeft(index)
              ...
              child: Text(
                DateFormat('dd MMM kk:mm')
                    .format(DateTime.fromMillisecondsSinceEpoch(document['timestamp'])),
  ...
  Widget buildListMessage() {
    ...
    d["type"]=0;
    d["content"]="hi";
    d["timestamp"]=1553243897000;
    m1.documents.add(d);
    var e = new Map();
    e["idFrom"]="t1";
    e["type"]=0;
    e["content"]="hi,g";
    e["timestamp"]=1553244100000;
    m1.documents.add(e);
    var msgs = new List();
    msgs.add(m1);
...
//            .limit(20)
//            .snapshots(),
        stream: Stream.fromIterable(msgs),
